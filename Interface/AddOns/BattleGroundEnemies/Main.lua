...
--[[
BattleGroundEnemies:RegisterEvent("ADDON_LOADED")

function BattleGroundEnemies:ADDON_LOADED(...)
	if select(1,...) == "Blizzard_PVPUI" then
		local ratings  = { "     0~1399", "1400~1599", "1600~1799", "1800~2099", "2100~2399", "2400~9999" }
		...
		PVPQueueFrame.HonorInset.RatedPanel.WeeklyChest:HookScript("OnEnter", function(self)
			if GameTooltip:IsVisible() then
				...
				GameTooltip:AddLine(" ")
				GameTooltip:AddLine("每周500点征服条打满奖励")
				GameTooltip:AddLine("首周 440  第2~9周 445  第10~25周 460")
				GameTooltip:Show()
			end
		end)
